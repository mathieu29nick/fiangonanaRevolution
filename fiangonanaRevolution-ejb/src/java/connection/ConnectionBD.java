...
public class ConnectionBD {
    ...
    {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        java.sql.Connection con = DriverManager.getConnection("jdbc:sqlserver://1213nickp13\\SQLEXPRESS;databaseName=fiangonanaRevolution;integratedSecurity=false;Trusted Connection=true","sa","mdpprom13 ");
        System.out.println(con+" haha");
        return con;
    }
}
